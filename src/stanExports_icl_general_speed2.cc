...
#include "stanExports_icl_general_speed2.h"

RCPP_MODULE(stan_fit4icl_general_speed2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_icl_general_speed2")
