...
namespace model_icl_general_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_icl_general");
    reader.add_event(110, 108, "end", "model_icl_general");
    return reader;
}
#include <stan_meta_header.hpp>
class model_icl_general : public prob_grad {
private:
        int M;
        int P;
        int N0;
...
public:
    model_icl_general(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_icl_general_namespace::model_icl_general";
            ...
            for (int m = 1; m <= M; ++m) {
                ...
                for (int i = 2; i <= N0; ++i) {
                    ...
                    stan::model::assign(cumm_sum, 
                                ...
                                (get_base1(cumm_sum, (i - 1), m, "cumm_sum", 1) + get_base1(y, m, "y", 1)), 
                ...
                for (int i = (N0 + 1); i <= N2; ++i) {
                    ...
                    stan::math::assign(convolution,0);
                    current_statement_begin__ = 48;
                    for (int j = 1; j <= (i - 1); ++j) {
                        current_statement_begin__ = 49;
                        stan::math::assign(convolution, (convolution + (get_base1(prediction, j, m, "prediction", 1) * get_base1(SI, (i - j), "SI", 1))));
                    }
                ...
                for (int i = 2; i <= N2; ++i) {
                    ...
                    for (int j = 1; j <= (i - 1); ++j) {
                        ...
                        stan::model::assign(E_deaths, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(m), stan::model::nil_index_list())), 
                                    (stan::model::rvalue(E_deaths, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_uni(m), stan::model::nil_index_list())), "E_deaths") + ((get_base1(prediction, j, m, "prediction", 1) * get_base1(f, (i - j), m, "f", 1)) * get_base1(ifr_noise, m, "ifr_noise", 1))), 
                                    "assigning variable E_deaths");
                    }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_icl_general_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_icl_general_namespace::model_icl_general stan_model;
#endif
